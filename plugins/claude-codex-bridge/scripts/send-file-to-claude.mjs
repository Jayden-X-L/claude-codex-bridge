...
if (!fileArg) {
  console.error("Usage: node plugins/claude-codex-bridge/scripts/send-file-to-claude.mjs <reply-file>");
  process.exit(2);
}
...
const result = spawnSync(process.execPath, [bridge, "to-claude", "--workspace", workspace, "--stdin", ...deliveryArgs, ...extraArgs], {
  input: payload,
